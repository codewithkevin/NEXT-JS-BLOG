...
const PostCard = ({post}) => {
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pd-12 mb-8'>
        ...
        hover:text-blue-700 text-3xl font-semibold text-black'>
        ...
        <div className="bloc lg:flex text-center items-center justify-center mb-8 w-full">
            ...
            <div className="font-medium text-gray-700">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline mr-2 text-blue-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
